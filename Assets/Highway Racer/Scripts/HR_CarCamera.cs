...
public class HR_CarCamera : MonoBehaviour
{
    ...
    void OnEnable() {
        ...
        HR_PlayerHandler.OnGameOver += HR_PlayerHandler_OnPlayerCrashed;
    ...
    /// </summary>
    /// <param name="player"></param>
    private void HR_PlayerHandler_OnPlayerCrashed(HR_PlayerHandler player, int[] scores, bool didWin)
    {
        gameover = true;
    }
